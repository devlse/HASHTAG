...
def crawling(search_word_receive):
    ...
    service_instance = Service('C:/Users/merry/workspace/Hashtag-project/backend/crawling_machine/chromedriver.exe')  # 상대경로절대경로
    ...
    wordcloud = WordCloud(
        font_path='C:/Users/merry/workspace/Hashtag-project/backend/crawling_machine/Fonts/GmarketSansTTFBold.ttf',  # 상대경로절대경로
    ...
    # plt.show()
    label_count += 1
    file_route_in = 'C:/Users/merry/workspace/Hashtag-project/static/image/test' + str(
